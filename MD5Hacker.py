...
class Patzhan:
    ...
    def start_hacking(self,id):
        ...
        while True:                
            ...
            thread_lst[0] = threading.Thread(target=Patzhan.generate, args=(start,t1_stop,md5,results_lst,0))
            thread_lst[1] = threading.Thread(target=Patzhan.generate, args=(t2_start,stop,md5,results_lst,1))
    ...
    def generate(start,stop,md5, results_lst,i):
        stop_char='z'
        length=len(start)
        s='a'
        ok=True
